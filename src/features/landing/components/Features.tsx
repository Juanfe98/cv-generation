...
const features = [
  {
    ...
    description:
      'Choose from designs crafted for clarity and impact. Optimized for ATS systems.',
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Download a perfectly formatted PDF ready to send to any employer.',
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Step-by-step sections make it easy to complete your CV without missing anything important.',
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Your data never leaves your browser. No servers, no accounts, no tracking.',
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Edit on desktop, tablet, or phone. Your CV syncs locally across sessions.',
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-slate-600">
            A modern CV builder designed for professionals who value their time.
          </p>
        </div>
