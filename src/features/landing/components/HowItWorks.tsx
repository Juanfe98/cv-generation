...
const steps = [
  {
    ...
    description:
      'Follow our guided editor through each section: personal info, experience, education, skills, and more.',
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Select from professional designs optimized for readability and ATS compatibility.',
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Download your polished CV as a PDF. Ready to send to employers in seconds.',
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-slate-600">
            No complicated software to learn. Just fill in your information and
